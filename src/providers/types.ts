...
export interface BillingInfo {
  /** Amount spent in whole currency units (providers convert from API format) */
  spentAmount: number | null;
  /** Currency code from the API, or null if not provided */
...
export interface ProviderConfig {
  ...
  type?: "anthropic" | "moonshot" | "glm" | "kimi" | "auto";
  /** Custom API base URL */
  apiUrl?: string;
